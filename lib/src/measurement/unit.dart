...
class Unit<K extends PhysicalProperty> extends Equatable {
  const Unit(this.systemOfMeasurent,
      {required this.name, required this.symbol});

  final SystemOfMeasurent<K> systemOfMeasurent;
  final String symbol;
  final String name;
...
class LinearConvertibleUnit<K extends LinearConvertiblePhysicalProperty>
    extends Unit<K> {
  const LinearConvertibleUnit(
      LinearConvertibleSystemOfUnits<K> systemOfMeasurent,
